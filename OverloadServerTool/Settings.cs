...
namespace OverloadServerTool
{
    public partial class OSTMain
    {
        ...
        {
            get { return Properties.Settings.Default.AutoUpdateOST; }
            set { Properties.Settings.Default.AutoUpdateOST = value; }
        }
        ...
        public void FindOverloadInstall(bool onlyOverload = false)
        {
            ...
            if (String.IsNullOrEmpty(OlmodPath) || !OverloadServerToolApplication.ValidFileName(OlmodPath))
            {
                ...
                if (OverloadServerToolApplication.ValidFileName(OlmodPath)) OlmodPath = Path.Combine(Path.GetDirectoryName(OverloadPath), "olmod.exe");
            }
            else
            {
                try
        ...
        public void LoadSettings()
        {
            ...
            AutoUpdateCheckBox.Checked = AutoUpdateOST;
